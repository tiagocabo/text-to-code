...
def preprocess_function(examples):
    ...
    model_inputs = tokenizer(model_input, padding="max_length", truncation=True, max_length=512, return_tensors="pt")
    labels = tokenizer(examples["output"], padding="max_length", truncation=True, max_length=512, return_tensors="pt")
